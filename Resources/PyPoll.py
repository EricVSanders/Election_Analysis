...
with open(file_to_save, "w") as txt_file:
    ...
    # Print the winning candidate's name, vote count and percentage of votes to the terminal
...
with open(file_to_save, "w") as txt_file:
    ...
    #txt_file.read(winning_candidate_summary)
